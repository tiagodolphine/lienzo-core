...
public class VerticalLayoutFactory
{
    ...
    private static Map<ReferencePosition, DirectionLayoutBuilder<VerticalAlignment>> builders = new HashMap<ReferencePosition, DirectionLayoutBuilder<VerticalAlignment>>()
    {{
        put(ReferencePosition.OUTSIDE, new OuterVerticalLayoutBuilder());
        put(ReferencePosition.INSIDE, new InnerVerticalLayoutBuilder());
    }};
    ...
    private static class OuterVerticalLayoutBuilder implements DirectionLayoutBuilder<VerticalAlignment>
    {
        @Override
    ...
    private static class InnerVerticalLayoutBuilder implements DirectionLayoutBuilder<VerticalAlignment>
    {
        @Override
        public Double apply(final BoundingBox parentBoundingBox, final BoundingBox childBoundingBox,
                final VerticalAlignment alignment, final Orientation orientation,
